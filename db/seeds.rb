...
majors = [
  ...
  DegreeMajor.new(title: "Robotics Engineering Major", user_id: nil, tree: {"type"=>"root", "children"=>[{"type"=>"course", "children"=>[], "subject"=>"CMPE", "number"=>"129C", "parentRel"=>"pre", "id"=>861}, {"type"=>"course", "children"=>[], "id"=>858, "subject"=>"CMPE", "number"=>"167/L", "parentRel"=>"pre"}, {"type"=>"course", "children"=>[], "id"=>857, "subject"=>"CMPE", "number"=>"141", "parentRel"=>"pre"}, {"type"=>"course", "children"=>[], "id"=>839, "subject"=>"CMPE", "number"=>"118/L", "parentRel"=>"pre"}, {"type"=>"course", "children"=>[], "id"=>853, "subject"=>"CMPE", "number"=>"115", "parentRel"=>"pre"}, {"type"=>"course", "children"=>[], "id"=>847, "subject"=>"CMPE", "number"=>"107", "parentRel"=>"pre"}, {"type"=>"course", "children"=>[], "id"=>841, "subject"=>"CMPS", "number"=>"101", "parentRel"=>"pre"}], "numChildrenRequired"=>"7"})
]
...
minors << DegreeMinor.create(title: "AMS Minor", tree: {"type"=>"root", "children"=>[{"type"=>"course", "children"=>[], "id"=>926, "subject"=>"MATH", "number"=>"23B", "parentRel"=>"pre"}, {"type"=>"course", "children"=>[], "id"=>927, "subject"=>"AMS", "number"=>"114", "parentRel"=>"pre"}, {"type"=>"course", "children"=>[], "id"=>928, "subject"=>"AMS", "number"=>"147", "parentRel"=>"pre"}, {"type"=>"course", "children"=>[], "id"=>929, "subject"=>"AMS", "number"=>"212A", "parentRel"=>"pre"}], "numChildrenRequired"=>"4"})
...
courses = [
  ...
  Course.new(subject: "PHYS", number: "5A/L", title: "Classical Mechanics", units: "7.0", season_fall: true, season_winter: false, season_spring: false, total_units: nil, node_id: nil, quarter_id: nil, timeline_id: nil, concurrent_parent_id: nil, user_id: nil, tree: {"type"=>"root", "children"=>[{"type"=>"course", "children"=>[], "subject"=>"MATH", "number"=>"19A", "parentRel"=>"co", "id"=>788}], "numChildrenRequired"=>1}),
  ...
  # AMS Minor courses
  Course.new(subject: "AMS", number: "212A", title: "Applied Math Methods I", units: "5.0", season_fall: false, season_winter: true, season_spring: false, tree: {"type"=>"root", "children"=>[], "numChildrenRequired"=>1}, is_static: false),
  Course.new(subject: "AMS", number: "147", title: "Computational Methods & Applications", units: "5.0", season_fall: false, season_winter: true, season_spring: false, tree: {"type"=>"root", "children"=>[{"type"=>"course", "children"=>[], "subject"=>"AMS", "number"=>"10", "parentRel"=>"pre", "id"=>935}], "numChildrenRequired"=>1}, is_static: false),
  Course.new(subject: "AMS", number: "114", title: "Introduction to Dynamical Systems", units: "5.0", season_fall: false, season_winter: true, season_spring: false, tree: {"type"=>"root", "children"=>[{"type"=>"course", "children"=>[], "subject"=>"AMS", "number"=>"20", "parentRel"=>"pre", "id"=>950}], "numChildrenRequired"=>1}, is_static: false),
  Course.new(subject: "AMS", number: "10", title: "Linear Algebra", units: "5.0", season_fall: true, season_winter: true, season_spring: false, tree: {"type"=>"root", "children"=>[], "numChildrenRequired"=>1}, is_static: false),
  Course.new(subject: "AMS", number: "20", title: "Differential Equations", units: "5.0", season_fall: false, season_winter: true, season_spring: true, tree: {"type"=>"root", "children"=>[{"type"=>"course", "children"=>[], "subject"=>"MATH", "number"=>"19B", "parentRel"=>"pre", "id"=>945}, {"type"=>"course", "children"=>[], "id"=>935, "subject"=>"AMS", "number"=>"10", "parentRel"=>"pre"}], "numChildrenRequired"=>"2"}, is_static: false),
  Course.new(subject: "MATH", number: "23B", title: "Vector Calculus II", units: "5.0", season_fall: true, season_winter: true, season_spring: true, tree: {"type"=>"root", "children"=>[{"type"=>"course", "children"=>[], "subject"=>"MATH", "number"=>"23A", "parentRel"=>"pre", "id"=>946}], "numChildrenRequired"=>1}, is_static: false),

  # Course.new(subject: "MATH", number: "23B", title: "Vector Calculus II", units: 5, season_fall: true, season_winter: true, season_spring: true),
  # Course.new(subject: "AMS", number: "114", title: "Introduction to Dynamical Systems", units: 5, season_fall: false, season_winter: true, season_spring: false),
  # Course.new(subject: "AMS", number: "147", title: "Computational Methods & Applications", units: 5, season_fall: false, season_winter: true, season_spring: false),
  # Course.new(subject: "AMS", number: "212A", title: "Applied Math Methods I", units: 5, season_fall: false, season_winter: true, season_spring: false),
  # (only if not using overlapping elective, in which case would do AMS231 (nonlinear control theory)
  # Course.new(subject: "", number: "", title: "", units: 0, season_fall: false, season_winter: false, season_spring: false)
  #
  # GEN-EDs
  Course.new(subject: "GEN-ED", number: "7C", title: "Cool Gen. Ed. C", units: "5.0", is_static: true),
  Course.new(subject: "GEN-ED", number: "7A", title: "Cool Gen. Ed. A", units: "5.0", is_static: true),
  Course.new(subject: "GEN-ED", number: "7B", title: "Cool Gen. Ed. B", units: "5.0", is_static: true),
  Course.new(subject: "GRAD", number: "XYZ", title: "Grad Level Course", units: "5.0", is_static: true), # temp for grad level course for robo major
]

# NOTE: robo courses not including the "Advanced Robotics Elective" courses
#
# # LEFT OFF seeding db, removed an error
